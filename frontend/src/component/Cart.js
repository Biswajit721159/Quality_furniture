                            ...
                            <div className='cartitem mt-4'>
                                ...
                                <div className='item1'>
                                    ...
                                    <div className='col2 mt-3'>
                                        <button className='btn btn-rounded-info btn-sm' disabled={cartdata <= 0 ? true : false} style={{ borderRadius: '40%' }} onClick={SUB_TO_CART}><GrSubtract /></button>
                                        <h4 className='cartcount'>
                                            {
                                                loadercart == true ? <ClipLoader size={'20px'} /> : cartdata
                                            }
                                        </h4>
                                        <button className='btn btn-rounded-info btn-sm' disabled={cartdata >= 5 ? true : false} style={{ borderRadius: '40%' }} onClick={Add_TO_CART}><GrAdd /></button>
                                    </div>
                                </div>
