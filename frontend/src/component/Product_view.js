...
export default function Product_view() {
	...
	function Add_TO_CART() {
		dispatch(
			AddToCartDB({ userinfo: userinfo, product_id: _id, product_count: 1, product: cartproduct })
		);
	}
							...
							<div className="col12">
								<div id="carouselExampleControls" className="carousel slide" data-ride="carousel">
									<div
										...
										style={{ border: "1px solid gray", borderRadius: 20 }}
									>
							...
							<div className="col3">
								<div className="card123">
									<div className="card-body">
										...
										<p className="card-text1" style={{ color: "#D68910" }}>
											{product.offer}% OFF
										</p>
										<h6 className="card-text1" style={{ color: "gray" }}>
											<s>₹{product.price}</s>
										</h6>
										<h6 className="card-text1" style={{ color: "green" }}>
											Price - ₹{(product.price - (product.price * product.offer) / 100).toFixed(2)}
										</h6>
