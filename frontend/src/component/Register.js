...
import { containsUppercase, containsLowercase, containsDigit, containsSpecialCharacter, extractMobileNumber } from "../helpers/user";
...
const Register = () => {
  ...
  function SendOTP() {
    ...
    if (checkAllInputfield()) {
      ...
      toast.warn("Please Fill All the filed using The Description")
    }
  }
