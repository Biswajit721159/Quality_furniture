										...
										<Card sx={{ m: 0.5, maxHeight: "310px" }}>
											...
											<div className="row mx-1">
												<div className="container col">
													<p className="card-text credit" style={{ color: "#D68910 " }}>
														{item.offer}% OFF
													</p>
												</div>
												<div className="container col">
													<p className="card-text credit" style={{ color: "gray" }}>
														<s>₹{item.price}</s>
													</p>
												</div>
											</div>
											...
											<div className="row mx-1" style={{ marginBottom: "50px" }}>
												<div className="col">
													{parseInt(item.rating) == 0 ? (
														<div className="card-text credit" style={{ color: "black" }}>
															{item.rating}
															<AiFillStar />
														</div>
													) : parseInt(item.rating) == 1 ? (
														<div className="card-text credit" style={{ color: "tomato" }}>
															{item.rating}
															<AiFillStar />
														</div>
													) : parseInt(item.rating) == 2 ? (
														<div className="card-text credit" style={{ color: "red" }}>
															{item.rating}
															<AiFillStar />
														</div>
													) : parseInt(item.rating) == 3 ? (
														<div className="card-text credit" style={{ color: "#DC7633" }}>
															{item.rating}
															<AiFillStar />
														</div>
													) : parseInt(item.rating) == 4 ? (
														<div className="card-text credit" style={{ color: "#28B463" }}>
															{item.rating}
															<AiFillStar />
														</div>
													) : parseInt(item.rating) == 5 ? (
														<div className="card-text credit" style={{ color: "green" }}>
															{item.rating}
															<AiFillStar />
														</div>
													) : (
												...
												<div className=" col">
													<h6 className="card-text credit" style={{ color: "tomato" }}>
